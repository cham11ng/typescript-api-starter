...
declare namespace Objection {
  ...
  type ModifierFunction<QB extends AnyQueryBuilder> = (
    qb: QB,
    ...args: any[]
  ) => void;
   ...
   */
  type DataPropertyNames<T> = Exclude<
   ...
   */
  type QueryBuilderType<T extends { QueryBuilderType: any }> =
    T['QueryBuilderType'];
  ...
  interface SetOperationsMethod<QB extends AnyQueryBuilder>
    extends BaseSetOperations<QB> {
    (...callbacksOrBuilders: QBOrCallback<QB>[]): QB;
  }

  interface UnionMethod<QB extends AnyQueryBuilder>
    extends BaseSetOperations<QB> {
  ...
  export class QueryBuilder<M extends Model, R = M[]>
    implements CatchablePromiseLike<R>
  {
    ...
    execute(): Promise<R>;
    castTo<MC extends Model>(
      modelClass: ModelConstructor<MC>
    ): QueryBuilderType<MC>;
  ...
  type ArrayQueryBuilderThunk<M extends Model> = () => ArrayQueryBuilder<
    QueryBuilderType<M>
  >;
  ...
  type RelationMappingColumnRef =
    | StringOrReferenceBuilder
    | StringOrReferenceBuilder[];
  ...
  export class ValidationError extends Error {
    constructor(
      args: CreateValidationErrorArgs & { modelClass?: ModelClass<Model> }
    );
  ...
  export class NotFoundError extends Error {
    constructor(
      args: CreateNotFoundErrorArgs & { modelClass?: ModelClass<Model> }
    );
  ...
  export class Model {
    ...
    static fromDatabaseJson<M extends Model>(
      this: Constructor<M>,
      json: object
    ): M;
